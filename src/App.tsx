...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#070b13] text-[#f3f4f6] flex flex-col items-center justify-start py-6 px-4 md:py-12 relative overflow-x-hidden selection:bg-emerald-500 selection:text-slate-950">
      ...
      <div className="w-full max-w-[420px] flex justify-center items-center relative z-10">
        
        <div className="w-full bg-slate-950 border-[6px] border-slate-800 rounded-[44px] shadow-[0_0_80px_rgba(0,0,0,0.6)] relative overflow-hidden aspect-[9/19] flex flex-col">
                      ...
                      <div>
                        <div className="relative">
                          ...
                          <input
                            ...
                            placeholder="0.00"
                            className="w-full bg-slate-950 border border-slate-800 rounded-2xl py-2.5 pl-11 pr-4 text-lg font-mono font-bold focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 text-white placeholder-slate-800 transition-all"
                            required
                          />
                        </div>
                      </div>
